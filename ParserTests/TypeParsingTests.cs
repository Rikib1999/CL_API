...
public class TypeParsingTests
{
    ...
    {
        [Option("-t", "--test", HelpText = "test help text", MaxParameterCount = 1)]
        public string TestString { get; set; }
        
        [Option("-n", "--number", HelpText = "number help text", MaxParameterCount = 1)]
        ...
        [Option("-d", "--double", MaxParameterCount = 1)]
    ...
    {
        var command = CommandParser<CorrectCommandDefinition>.Parse("-n", _commandDefinition);
    ...
    {
        var command = CommandParser<CorrectCommandDefinition>.Parse("-t", _commandDefinition);
        
        Assert.Multiple(() =>
        {
            Assert.That(command.TestNumber, Is.Zero);
